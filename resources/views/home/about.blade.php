...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="filosofi">
            ...
            <ul>
                <li><img src="{{asset('profil/img/filosofi-1.png')}}"> Memberikan produk berkualitas tinggi dengan harga terjangkau</li>
                <li><img src="{{asset('profil/img/filosofi-2.png')}}"> Mengembangkan inovasi produk sesuai selera konsumen dan trend pasar</li>
                <li><img src="{{asset('profil/img/filosofi-3.png')}}"> Memberikan kepuasan pada konsumen dengan pelayanan yang maksimal</li>
            </ul>
            <br>
        </div>
        <a href="produk.html" class="add-to-cart">Beli Sekarang <i class="fas fa-arrow-right"></i></a>
    </section>
    <!-- About Section End -->
