    ...
    <section id="product" class="product">
        <div class="product-display">
            <div class="main-image" id="sticky-image">
                <img id="main-img" src="{{ asset('profil/img/medium-1.png') }}" alt="Main Product Image">
                <div class="thumbnails">
                    <img src="{{ asset('profil/img/medium-1.png') }}" alt="Premium Terrarium Substrate Mix Thumbnail" onclick="changeMainImage(this)">
            ...
            <div class="product-details">
                <p>Terrarium.qu</p>
                <h2>Kit DIY Terrarium Tipe Medium Bell Jar</h2>
                <p>Rp 70.000 IDR</p><br>
        ...
        <div class="footer-container">
          ...
          <div class="footer-right">
            <div class="social-icons">
                ...
                <a href="wa.me/+6289608543320"><i class="fab fa-whatsapp"></i></a>
            </div>
          </div>
        </div>
      </footer>
...
function changeMainImage(img) {
    ...
    mainImg.src = img.src;
    mainImg.style.width = '75%'; // Mengatur lebar gambar utama sesuai dengan gambar yang dipilih
    mainImg.style.height = '75%'; // Mengatur tinggi gambar utama sesuai dengan gambar yang dipilih
}
