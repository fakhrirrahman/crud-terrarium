    ...
    <section id="product" class="product">
        <div class="product-display">
            <div class="main-image" id="sticky-image">
                <img src="{{ asset('profil/img/standard-1.jpg') }}" id="main-img">
                <div class="thumbnails">
                    <img src="{{ asset('profil/img/standard-1.jpg') }}" alt="Standard Terrarium Substrate Mix Thumbnail" onclick="changeMainImage(this)">
            ...
            <div class="product-details">
                <p>Terrarium.qu</p>
                <h2>Kit DIY Terrarium Tipe Standar Glass Jar</h2>
                <p>Rp 50.000 IDR</p><br>
